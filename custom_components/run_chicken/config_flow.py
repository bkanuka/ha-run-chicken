...
class Discovery:
    ...
    device: RunChickenDeviceData


def get_name(device: RunChickenDeviceData) -> str:
...
class RunChickenConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def _get_device_data(
        ...
        if ble_device is None:
            ...
            raise RunChickenDeviceUpdateError("No ble_device")

        run_chicken = RunChickenDevice()

        try:
            data = await run_chicken.update_device(ble_device)
            ...
            raise RunChickenDeviceUpdateError("Failed getting device data") from err
